        ...
        <div className="flex flex-col">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6 cursor-pointer">
              <p
                onClick={() => router.push(`${!user.role ? '/' : user.role == Roles.Admin ? '/dashboard' : '/profile' }`)}

                className="rounded-md bg-secondary px-3.5 py-2.5 text-sm font-semibold text-black shadow-sm hover:bg-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secodarybg-secondary"
              >
                Go back home
              </p>
