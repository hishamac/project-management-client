export default function Home() {
  ...
  return (
    <>
      ...
      {/* Primary Meta Tags */}
      <title>Tailwind CSS Project Sample</title>
      <meta name="title" content="Tailwind CSS Project Sample" />
      <meta
        name="description"
        content="Learning Tailwind CSS. This is static web page using Tailwind CSS."
      />
      <link
        rel="stylesheet"
      ...
      {/* Banner */}
      <section>
        <div className="md:pt-32 pt-14 mx-auto max-w-7xl pb-14 text-center">
          ...
          <p className="mx-auto max-w-2xl mt-6 text-lg text-slate-500">
          ...
          <div className="flex justify-center items-center mt-5 gap-3">
            <a
              href="#"
              className="rounded-full bg-slate-900 text-white hover:bg-slate-700 hover:text-slate-100 py-2 px-4"
            >
              Get 6 months free
            </a>
            <a
              href="#"
              className="rounded-full flex justify-center items-center text-slate-700 ring-2 hover:text-slate-900 hover:ring-slate-300 py-2 px-4 gap-2"
            >
              <svg
                aria-hidden="true"
        ...
        <div className="pb-20 mt-14 justify-center items-center">
          <h3 className="text-center text-slate-900 font-semibold">
                ...
                <li>
                  ...
                  >
                    <g clipPath="url(#a)" fill="#334155">
                      ...
                      <path d="M20.816 44.712C9.338 44.712 0 35.356 0 23.856 0 12.356 9.338 3 20.816 3s20.816 9.356 20.816 20.856c0 11.5-9.338 20.856-20.816 20.856Zm0-38.931c-9.945 0-18.04 8.11-18.04 18.075s8.095 18.075 18.04 18.075c9.946 0 18.04-8.11 18.04-18.075S30.763 5.781 20.817 5.781h-.001Z" />
                    </g>
                    <defs>
                      <clipPath id="a">
                ...
                <li>
                  ...
                  >
                    <g clipPath="url(#a)" fill="#334155">
                      ...
                      />
                      <path d="M9.62 35.173c-.611 0-1.107.5-1.107 1.117s.496 1.116 1.107 1.116h24.42c.612 0 1.108-.5 1.108-1.116 0-.617-.496-1.117-1.107-1.117H9.62Zm8.513 5.59c-.613 0-1.11.5-1.11 1.119 0 .617.497 1.118 1.11 1.118h7.396c.612 0 1.109-.5 1.109-1.118 0-.618-.497-1.12-1.11-1.12h-7.395Z" />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                ...
                <li>
                  ...
                  >
                    <g clipPath="url(#a)" fill="#334155">
                      ...
                      />
                      <path d="M76.281 34.36h3.262V23.523h5.596v-3.24H76.28V34.36h.001Zm32.916-3.297 4.099-10.78h3.304l-5.354 14.077h-4.099l-5.353-14.077h3.303l4.1 10.78Z" />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
      ...
      <section>
        <div className="bg-blue-500 pt-10 pb-10 md:text-center mx-auto px-5">
          <h1 className="text-4xl md:text-3xl tracking-tight text-slate-100">
            Everything you need to run your books.
          </h1>
          <p className="text-slate-100 pt-5 sm:text-2xl">
      ...
      {/* business tasks */}
      <section>
        <div className="mx-auto max-w-2xl md:text-center pt-14 px-5 pb-10">
          <h2 className="text-4xl md:text-3xl tracking-tight text-slate-900">
        ...
        <div className="flex md:flex-row flex-col md:mx-8 px-5 gap-x-5 gap-y-10 pb-10">
          <div className="cursor-pointer">
            {/* icon */}
            <div className="bg-blue-700 hover:bg-blue-900 rounded-md w-9 mb-5">
            ...
            {/* text */}
            <div>
              <span className="text-slate-700 hover:text-slate-700 mb-5">
                Reporting
              </span>
              <h1 className="text-2xl text-slate-700 hover:text-slate-900 mb-5">
      ...
      {/* Get started today */}
      <section>
        <div className="bg-gradient-to-r from-cyan-500 to-blue-500 text-center pt-20 pb-10">
          <div className="mx-auto max-w-lg">
            <h1 className="text-4xl tracking-tight text-white">
              Get strated today
            </h1>
            <p className="text-white tracking-tight text-lg mt-3">
              It’s time to take control of your books. Buy our software so you
              can feel like you’re doing something productive.
            </p>
            <button className="bg-slate-100 rounded-full py-2 px-4 mt-5 font-bold">
              Get 6 months free
            </button>
          </div>
        </div>
      ...
      {/*  Loved by business */}
      <section>
        <div className="pt-20 pb-10 bg-slate-50">
          <div className="mx-auto text-center max-w-lg mt-10 mb-10">
            <h1 className="text-4xl">Loved by businesses worldwide.</h1>
            <p className="tracking-tight text-lg mt-3">
          ...
          <div className="space-y-5">
            <div className="px-8">
              <ul className="max-w-2xl grid xl:grid-cols-3 grid-cols-1 lg:max-w-none mx-auto gap-6">
                <li>
                  <div className="rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                    ...
                    <div className="flex justify-between items-center pt-5">
                      <div>
                        <h1 className="mb-2">Sheryl Berge</h1>
                        <span className="text-slate-600">CEO at Lynch LLC</span>
                      </div>
                ...
                <li>
                  <div className="rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                    ...
                    <div className="flex justify-between items-center pt-5">
                      <div>
                        <h1 className="mb-2">Leland Kiehn</h1>
                      ...
                      <div className="rounded-full">
                        <img
                          src="./assets/images/avatar-5.webp"
                          alt=""
                          className="w-14 h-14 rounded-full"
                        />
                      </div>
                ...
                <li>
                  <div className="rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                    ...
                    <div className="flex justify-between items-center pt-5">
                      <div>
                        <h1 className="mb-2">Peter Renolds</h1>
                        <span className="text-slate-600">
                          Founder of West Inc
                        </span>
                      </div>
              ...
              <ul className="max-w-2xl grid xl:grid-cols-3 grid-cols-1 lg:max-w-none mx-auto gap-6">
                <li>
                  <div className="rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                    ...
                    <div className="flex justify-between items-center pt-5">
                      ...
                      <div className="rounded-full">
                        <img
                          src="./assets/images/avatar-4.webp"
                          alt=""
                          className="w-14 h-14 rounded-full"
                        />
                      </div>
                ...
                <li>
                  <div className="rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                    ...
                    <div className="flex justify-between items-center pt-5">
                      <div>
                        <h1 className="mb-2">Erin Powlowski</h1>
                        <span className="text-slate-600">
      ...
      <section className="bg-slate-900">
        <div className=" mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-20">
          <div className="mx-auto text-center pt-10 pb-10 items-center justify-center">
          ...
          <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
            <div className="p-2 sm:px-5">
              <h1 className="text-6xl text-white">$9</h1>
              <h3 className="text-white text-lg">Starter</h3>
              <p className="text-slate-200">
                Good for anyone who is self-employed and just getting started.
              </p>
              <button className="ring-1 inline-flex rounded-full py-2 px-20 mt-3 text-white hover:ring-slate-100">
                Get started
              </button>
              <ul className="mt-10 text-sm text-slate-200 font-semibold space-y-3">
                <li className="flex ">
                  <svg
                    aria-hidden="true"
            ...
            <div className="bg-blue-800 rounded-3xl px-5 py-8">
              <h1 className="text-6xl text-white">$9</h1>
              <h3 className="text-white text-lg">Starter</h3>
              <p className="text-slate-200">
                Good for anyone who is self-employed and just getting started.
      ...
      <section className="bg-slate-50 py-20 relative overflow-hidden">
        <img
          ...
          height={946}
        />
        <div className="relative mx-auto max-w-7xl lg:px-8 px-4 sm:px-6">
          <div className="">
          ...
          <ul className="grid grid-cols-1 lg:grid-cols-3 mt-16 mx-auto gap-7">
            <li>
      ...
      <footer>
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="flex items-center justify-center space-x-8 mt-17 mb-10">
            <a href="#">Features</a>
