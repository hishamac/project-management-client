...
firebase
  ...
  .on("child_added", function (snapshot) {
    ...
    if (snapshot.val().sender == myName) {
      ...
      html +=
        "<div class='bg-slate-400 relative max-w-xl px-4 py-2 text-gray-700 rounded shadow transition-all'>";
      html +=
        "<svg class='w-6 h-6' fill='none' stroke='currentColor' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' data-id='" +
        snapshot.key +
        "' onclick='deleteMessage(this);'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16'></path></svg>";
      html += "<span class='block break-words'>You: ";
    } else {
      html += "class='flex justify-end'>";
      html +=
        "<div class='bg-slate-300 relative max-w-xl px-4 py-2 text-gray-700 rounded shadow transition-all'>";
